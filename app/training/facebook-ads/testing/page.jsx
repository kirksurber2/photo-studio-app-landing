...
export const metadata = {
  title: "Testing Facebook Ads | Photo Studio App Training",
  description: "Learn why testing your ads is a cost effective method prior to launching your ads.",
  keywords: "Testing photography ads, low cost marketing, facebook targeting, photography business marketing, advertising photography"
};

export default function TestingAds() {
  return (
